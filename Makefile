...
aws_iot_sdk_t2_pal=$(T2AWS_LOC)/talaria_two_pal/
...
apps = \
    ...
    jobs_sample.elf.strip \
    shadow_sample.elf.strip
...
subscribe_publish_sample_obj = \
    ${app_src}subscribe_publish_sample/subscribe_publish_sample.o
...
#jobs_sample app code
jobs_sample_obj = \
    ${app_src}jobs_sample/jobs_sample.o

jobs_sample-virt = yes

# Reference -- add the libraries used by the Application, including aws_iot libraries created
$(objdir)/jobs_sample.elf:LIBS = \
    -lcomponents -laws_iot_sdk_t2 -laws_iot_sdk_t2_pal -lmbedtls -lwifi -llwip2 -limath -linnobase -ldragonfly
...
shadow_sample_obj = \
    ${app_src}shadow_sample/shadow_sample.o

shadow_sample-virt = yes

# Reference -- add the libraries used by the Application, including aws_iot libraries created
$(objdir)/shadow_sample.elf:LIBS = \
    -lcomponents -laws_iot_sdk_t2 -laws_iot_sdk_t2_pal -lmbedtls -lwifi -llwip2 -limath -linnobase -ldragonfly
